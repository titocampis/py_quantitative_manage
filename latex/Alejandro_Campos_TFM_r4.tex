...
\begin{titlepage}
    ...
    % Subtítulo
    {\Large
    Anàlisi dels hàbits de lectura de l'alumnat des de 3r d'ESO fins a 2n de Batxillerat i dels factors relacionats en un centre educatiu de l'Hospitalet de Llobregat.
    \par}
...
La lectura és una activitat que ens defineix com a espècie, que ens han permès durant mil·lennis transmetre el coneixement entre persones, generacions i cultures \parencite{shutaleva}. Han estat eines utilitzades globalment per a l'aprenentatge, la creativitat, l'entreteniment, l'expressió d'emocions, la reflexió, la transmissió d'històries i experiències, la preparació d'estratègies, l'organització, el recordatori, etc. La lectura és una activitat que implica tots els tipus de raonament: lògic, crític, creatiu, analític, imaginatiu, empàtic i reflexiu \parencite{chiweta_sm}.

Entre el mite i la realitat, es diu que Alexandre Magne dormia amb una còpia de la Ilíada sota el coixí en les seves campanyes militars \parencite{plutarc}; Juli Cèsar preparava estratègies militars a través de la lectura i l'escriptura mentre la resta de generals descansaven; Cleopatra va créixer entre llibres a la gran biblioteca d'Alexandria \parencite{posteguillo_maldita}; Napoleó viatjava a les seves campanyes militars amb una biblioteca portàtil amb centenars de llibres; Winston Churchill es va negar a reduir el pressupost de cultura dels Estats Units per destinar al finançament de la Segona Guerra Mundial \parencite{posteguillo_tertulia}, entre molts d'altres.
...
Llegir per plaer durant la infància es correlaciona amb una millor memòria, desenvolupament cognitiu, desenvolupament del llenguatge, hàbits de son, habilitats comunicatives i salut mental \parencite{sun_childhood}. Altres estudis com \textcite{billington_reading} conclouen que la pràctica de la lectura per plaer està vinculada a una major autoestima, autoacceptació, creativitat, habilitats socials i empatia. La lectura freqüent s'associa amb un menor risc de deteriorament de les funcions cognitives en persones grans i millors resultats en tots els nivells educatius \parencite{chang_reading}. \textcite{banas_biblio} conclouen que la participació en clubs de lectura es correlaciona amb millors habilitats psicosocials i un major benestar.

D'altra banda, la lectura és considerada una activitat relacionada amb la pràctica de l’atenció plena o \emph{mindfulness}, ja que requereix focalitzar l’atenció de manera sostinguda, reduir les distraccions i estar activament en el moment present per comprendre el text i endinsar-se en la narració \parencite{gorsy}. En aquest sentit, els beneficis associats al cultiu de l’atenció plena s’han relacionat àmpliament amb una millora del benestar emocional, la salut mental i la regulació de les emocions \parencite{baena}.

Finalment, el marc normatiu català actual sustenta que la lectura, com a base d’altres aprenentatges, esdevé un factor fonamental per a l’adquisició i desenvolupament de les competències bàsiques, i que, per tant, la lectura ha de ser una prioritat en els centres i en la tasca de tot docent \parencite{generalitatPLEC}. També subratlla que saber llegir ens permet créixer com a persona, desenvolupar el coneixement i interactuar en la nostra societat.

\subsection{La lectura com activitat sociocultural}

Les pràctiques culturals constitueixen un pilar fonamental del comportament humà; comprenent un ventall ampli d'activitats com costums socials, rituals, tradicions, normes, valors, formes d'expressar-se, etc. \parencite{shutaleva}. Aquestes pràctiques proporcionen un marc per a la interacció social i defineixen la identitat d'una societat, donant lloc a patrons culturals que no són fixes ni immutables, sinó que evolucionen constantment en resposta a canvis socials, polítics, econòmics i tecnològics del context històric \nesteddoubleparencite{Kirillova et al.}{2022}{Hofstede et al.}{2009}{shutaleva}.
...
Parlant amb diferents adolescents del meu entorn i alumnes del centre de pràctiques, he tingut la sensació que una gran majoria no llegeix llibres o còmics per oci mai o quasi mai i que no tenen hàbits de lectura, ni a casa ni a l'escola. Quan els hi he preguntat per què no ho fan, molts d'ells m'han dit que no els agrada, que és avorrit, que prefereixen altres activitats, que no els aporta res o que no tenen temps per això. D'altra banda, molts d'ells dediquen una quantitat considerable d'hores al dia a l'ús d'eines digitals, xarxes socials i plataformes de contingut audiovisual ràpid.

També he observat que molts d'ells presenten dificultats a l'hora de comprendre diferents textos que se'ls proposa, com enunciats d'exercicis, textos informatius, guies de treball, etc. I que no estan habituats i els costa extreure la informació rellevant d'un text o mantenir l'atenció i el fil de la lectura quan aquesta és llarga. 
...
Partint del context descrit en l'apartat \nameref{intro}, he volgut enfocar la meva investigació en la composició d'una fotografia completa dels hàbits de lectura de l'alumnat de 3r d'ESO fins a 2n de Batxillerat en el meu centre de pràctiques. En concret, es pretén descriure variables com el temps dedicat a la lectura per oci, les preferències temàtiques, els formats més utilitzats, la quantitat de lectures realitzades anualment i la percepció de l’alumnat envers la lectura, així com el grau de seguiment de les lectures obligatòries, l’ús de recursos com resums o eines d’IA generativa i la freqüència d’ús de la biblioteca escolar.
...
D'aquesta manera, la pregunta de recerca que guia aquest estudi és: quins són els hàbits de lectura de l’alumnat de 3r d'ESO fins a 2n de Batxillerat del centre educatiu estudiat i quins factors es troben associats al seu desenvolupament?

En coherència amb aquesta pregunta, l’objectiu general de la recerca és descriure de forma detallada i exhaustiva els hàbits de lectura de l’alumnat de 3r d'ESO fins a 2n de Batxillerat en el centre d'estudi, així com de les possibles variables que hi poden estar relacionades.
...
\begin{itemize}
    ...
    \item Analitzar l’ús de les tecnologies digitals i les xarxes socials en relació amb els hàbits lectors.
...
La via d’administració del qüestionari ha estat en línia, fent ús de la plataforma Google Forms, per al disseny, la distribució i la recollida de dades, que, posteriorment, s'han descarregat en format CSV per tractar-les amb el programari Python3. Per aquest motiu el qüestionari s'ha subministrat durant l’horari lectiu, amb ordinadors i connexió a internet facilitats pel centre educatiu.
...
D'igual manera, per a la realització de les entrevistes semiestructurades, s'ha obtingut el consentiment informat dels participants (en el cas dels adults), i el consentiment dels pares o tutors legals en el cas dels menors. Abans de realitzar les entrevistes s'han explicat els objectius de les entrevistes, la voluntarietat de la participació, la possibilitat de retirada en qualsevol moment i la completa confidencialitat de les respostes. També s'ha fet saber l'ús ètic que es faria de les dades recollides, assegurant que l'únic ús que se'n faria seria per a la consecució dels objectius d'aquest estudi i que no es compartiria amb tercers ni es faria públic de cap manera que pogués identificar els participants.
...
En primer lloc, s'han exportat les dades recollides al qüestionari en format CSV. Aquest fitxer serà posteriorment tractat amb el programari Python3, utilitzant principalment les llibreries \emph{pandas}, \emph{scipy}, \emph{numpy} i \emph{matplotlib}.
...
Per tal d’obtenir una aproximació quantitativa del volum total de lectura anual de llibres o còmics per oci, s’ha construït una variable discreta derivada que estima el nombre de pàgines llegides de llibres o còmics en els últims 12 mesos per oci. Aquesta variable s’ha calculat a partir de la combinació de dues variables recollides en el qüestionari: el nombre de llibres o còmics llegits en els últims 12 mesos per oci (agrupat en categories ordinals d'interval) i el nombre mitjà de pàgines per llibre (també categoritzat en categories ordinals d'interval).
