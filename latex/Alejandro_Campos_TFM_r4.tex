...
Els resultats mostren que els hàbits lectors per oci són, en general, baixos, amb una distribució clarament asimètrica en què una minoria d’alumnes concentra una part important del volum de lectura. En relació amb el gènere, les noies presenten clarament hàbits lectors més elevats que els nois; tanmateix, aquesta variable per si sola no és determinant per explicar els hàbits lectors dels adolescents.
...
Quant a les lectures obligatòries del centre, es detecta una baixa valoració general i una relació feble amb els hàbits lectors per oci, fet que suggereix una certa desconnexió entre la lectura acadèmica i la lectura per oci.
...
With regard to mandatory school readings, a generally low rating has been observed, as well as a weak association with leisure reading habits, suggesting a disconnect between academic reading and leisure reading.
...
Finalment, també vull agraïr a tots els amics, familiars i professors de l'escola que, d'una manera o altra, m'han donat suport o ajudat durant tot el procés de realització d'aquest estudi, ja sigui a través de converses, recomanacions, idees, habilitació de moments i espais, o participació.
...
Tal com s'ha esmentat, malgrat la baixa freqüència general de lectura de llibres o còmics per oci, també s’observa l’existència d’un grup reduït però clarament consolidat de lectors habituals, amb volums de lectura molt superiors a la resta de la mostra. Aquest fet, com hem vist, és el que provoca que la distribució sigui fortament asimètrica, suggerint una elevada polarització dels hàbits lectors de llibres o còmics per oci dins l’alumnat.
...
Aquesta percepció coincideix amb l'elevada asimetria de la distribució dels resultats quantitatius, on una minoria d'alumnes concentra una part molt important del volum total de lectura per oci, mentre les mesures de tendència central reflecteixen nivells molt baixos per a la major part de l'alumnat.

Els resultats obtinguts són coherents amb l'estudi de \textcite{johnsson_bookreading}, en que es conclou que la lectura s'ha polaritzar lleugerament amb el pas del temps: s'ha incrementat el nombre d'adolescents que no llegeixen mai per oci, mentre que els que ja llegien han augmentat el temps de lectura. En canvi, són parcialment congruents amb els resultats de l'Informe de resultados de Hábitos de lectura y compra de libros en España \nestedtextcite{2018}{sanches}, ja que aquest estudi conclou que els nivells de lectura són generalment baixos, però els percentatges són considerablement més elevats que els obtinguts en el present estudi.
...
De manera coherent, els resultats relacionats amb el consum de contingut audiovisual sobre llibres o lectura també apunten en aquesta direcció. Lluny d’actuar com a competidor de la lectura, dedicar temps a veure o sentir aquest tipus de contingut sembla funcionar un estímul que reforça els hàbits lectors per oci de l'alumnat del centre; configurant un espai de socialització lectora, on els adolescents poden descobrir nous llibres, compartir recomanacions i sentir-se part d’una comunitat lectora.

Les dades qualitatives reforcen aquesta interpretació, ja que diversos participants assenyalen que les recomanacions de llibres per part de persones del seu entorn o a través de plataformes digitals són un factor clau en el descobriment de nous i llibres i en la motivació per llegir.
...
Especialment rellevant és la relació feble-moderada observada entre compartir opinions sobre lectures amb la família i els hàbits lectors per oci. Aquest resultat és coherent amb els resultats obtinguts a l’apartat \nameref{sec:narrativa}, on també es va observar una associació positiva entre compartir opinions sobre lectures amb amistats, o consumir contingut audiovisual relacionat amb la lectura, i hàbits lectors per oci més consolidats. En conjunt, aquests resultats suggereixen que les interaccions socials al voltant de la lectura, tant en l’àmbit familiar com en l’àmbit de les amistats, poden tenir un paper rellevant en la configuració dels hàbits lectors per oci de l’alumnat del centre, reforçant la idea que la lectura és una pràctica social vinculada a la interacció, la recomanació i el sentit de pertinença a un grup lector.

Tanmateix, compartir opinions amb amics i amigues presenta una associació més forta amb els hàbits lectors que compartir opinions amb les famílies, suggerint que les interaccions socials entre iguals al voltant de la lectura podrien tenir un paper més rellevant en la consolidació dels hàbits lectors per oci que les interaccions familiars. Aquest fet és congruent amb la literatura existent, que assenyala que en l’adolescència les relacions amb el grup de pars són una part d'influència i socialització molt rellevant \parencite{arnett}.
