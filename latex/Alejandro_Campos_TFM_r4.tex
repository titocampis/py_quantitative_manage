...
També vull agrair a tots els amics, familiars, professors i alumnes de l'escola que, d'una manera o altra, m'han donat suport o ajudat durant tot el procés, ja sigui a través de converses, recomanacions, idees, facilitant moments i espais de treball o participant directament en la recerca.
...
Els resultats obtinguts són coherents amb els de l'estudi de \textcite{johnsson_bookreading}, on es conclou que les noies llegeixen més que els nois, i que aquesta diferència es manté al llarg del temps. 
...
En conjunt, els resultats són coherents amb obtinguts a \textcite{johnsson_bookreading} i \textcite{shutaleva}, que assenyalen que els hàbits de lectura estan més condicionats pel context social que no pas per l’ús de tecnologies digitals. La literatura existent també destaca la gran importància del grup de pars en l'etapa adolescent \parencite{berger}. 
