...
\subsectiononumber{Resum}
% =======================================================================

En el present estudi s’analitzen els hàbits lectors de llibres o còmics per oci de l’alumnat adolescent d’un centre educatiu, així com els factors personals, familiars, socials, educatius i tecnològics associats. L’estudi combina una aproximació quantitativa, basada en un qüestionari \emph{ad hoc}, amb una aproximació qualitativa a partir de les percepcions d’alumnat i professorat, amb l’objectiu d’obtenir una visió integrada dels hàbits lectors per oci dels alumnes adolescents del centre.

Els resultats mostren que els hàbits lectors per oci són, en general, baixos, amb una distribució clarament asimètrica en què una minoria d’alumnes concentra una part important del volum de lectura. En relació amb el gènere, les noies presenten clarament hàbits lectors més elevats que els nois; tanmateix, aquesta variable per si sola no és determinant per explicar els hàbits lectors dels adolescents del centre.

S’ha observat que la lectura per oci és una activitat considerablement social, ja que variables com compartir opinions sobre lectures —ja sigui amb el grup d’iguals, amb la família o a través de xarxes socials— es correlacionen positivament amb els hàbits lectors per oci.

Pel que fa a les noves tecnologies, les plataformes de contingut audiovisual i les xarxes socials, no s’han trobat resultats prou consistents per afirmar l’existència d’una competència temporal directa amb la lectura per oci. Més aviat, la relació observada apunta a una possible fragmentació de l’atenció que aquest tipus de consum digital pot generar, i a com aquesta pot afectar la pràctica lectora.

Quant a les lectures obligatòries del centre, es detecta una baixa valoració general i una relació feble amb els hàbits lectors per oci, fet que, reforçat per les dades qualitatives, suggereix que la lectura obligatòria del centre no actua com un factor de promoció dels hàbits lectors per oci. 

Finalment, els resultats apunten a un paper moderat de l’entorn familiar en el desenvolupament dels hàbits lectors de l’alumnat del centre, principalment a través de la disponibilitat de llibres a casa i de la freqüència amb què es comparteixen opinions o recomanacions sobre lectures. Tot i això, aquesta associació és menor en comparació amb factors personals i socials.

En conjunt, l’estudi suggereix que els hàbits lectors de l’alumnat adolescent del centre s’associen a una combinació de factors personals, socials, contextuals i familiars, amb un pes destacat de les interaccions socials i del sentiment de pertinença a un grup o comunitat lectora.
\\[4ex]
\textbf{Paraules Clau:} hàbits de lectura, adolescència, factors associats, context educatiu, noves tecnologies, entorn familiar pro-lector, activitat social.

\newpage
\subsectiononumber{Abstract}
% =======================================================================
This study analyzes leisure reading habits of books and comics among adolescent students in an educational center, as well as the personal, family, social, educational, and technological factors associated with them. The research combines a quantitative approach, based on an \emph{ad hoc} questionnaire, with a qualitative approach based on the perceptions of students and teachers, with the aim of obtaining an integrated understanding of the adolescent students leisure reading habits at this particular school.

The results show that leisure reading habits are generally low, with a clear asymmetry in which a minority of students account for a large share of total reading volume. Regarding gender, girls clearly show higher levels of leisure reading than boys; however, this variable alone is not sufficient to explain the reading habits of the adolescent students at the center.

Reading for leisure is shown to be a highly social activity, as variables such as sharing opinions about reading ---whether with peers, family, or through social media--- are positively associated with leisure reading habits.

About new technologies, audiovisual platforms, and social media, no consistent evidence has been found to support the existence of a direct time-based competition with leisure reading. Rather, the observed relationship points to a possible fragmentation of the attention generated by this kind of digital consumption, which may in turn affect reading practices.

With regard to mandatory school readings, a generally low rating has been observed, as well as a weak association with leisure reading habits, which, reinforced by qualitative data, suggests that mandatory school reading does not act as a factor in promoting leisure reading habits.

Finally, the results point to a moderate role of the family environment in the development of students’ reading habits, mainly through the availability of books at home and the frequency of sharing opinions or recommendations about reading. However, this association is weaker compared to personal and social factors.
\\[4ex]
\textbf{Keywords:} reading habits, adolescence, associated factors, educational context, new technologies, pro-reading family environment, social activity.

\newpage
\subsectiononumber{Agraïments}
% =======================================================================
De manera especial, vull agrair a la meva parella, Clàudia, el seu suport incondicional, la seva paciència, les seves idees i la seva companyia durant tot el procés de realització d'aquesta recerca. Has estat un pilar fonamental en aquest projecte, gràcies.

També vull agrair de manera especial a la meva mare, Silvia, la seva confiança plena i el seu suport. Gràcies per creure sempre en mi.

Vull agrair a tots els amics, familiars, professors i alumnes de l'escola que, d'una manera o altra, m'han donat suport o ajudat durant el procés, ja sigui a través de converses, recomanacions, idees, facilitant moments i espais de treball o participant directament en la recerca.

Gràcies a tots i totes per la vostra ajuda, suport i companyia. Sense vosaltres, aquest estudi no hauria estat possible.

Finalment, vull agrair a totes les persones que, en algun moment o altre, dediquin part del seu temps no remunerat a llegir algunes de les línies que apareixen en aquest estudi. Al cap i a la fi, aquest és el seu veritable sentit: la lectura per oci.
...
Les pràctiques culturals constitueixen un fonamental del comportament humà, comprenent un ventall ampli d'activitats com costums socials, rituals, tradicions, normes, valors, formes d'expressar-se, etc. \parencite{shutaleva}. Aquestes pràctiques proporcionen un marc per a la interacció i defineixen la identitat d'una societat, donant lloc a patrons culturals que no són fixes ni immutables, sinó que evolucionen constantment en resposta a canvis socials, polítics, econòmics i tecnològics \nesteddoubleparencite{Kirillova et al.}{2022}{Hofstede et al.}{2009}{shutaleva}.

La lectura és una pràctica cultural que depèn del context històric concret, però que alhora contribueix a modelar-lo i transformar-lo. Sovint, s'entén el llenguatge, i per tant la lectura, com a mera eina per transmetre la informació que ja hi és a la nostra ment (metàfora de la conducció; Michel Reddy, 1979, citat a Gil Juárez i Vitores González, 2009). Res més allunyat de la realitat, ja que el llenguatge, i en conseqüència la lectura, construeixen i modelen la interpretació individual i col·lectiva de la realitat \parencite{gil_comu}. <<Els límits del nostre llenguatge són els límits del nostre món>> \nestedparencite{Wittgenstein}{1922}{lanza_wittgenstein}.

En aquest estudi s'analitzarà la lectura des d'un punt de vista transversal, com una activitat que s'integra en el context sociocultural d'un centre de l'Hospitalet de Llobregat. D'aquesta manera, no s'entén la lectura com una activitat aïllada, sinó com una pràctica cultural influenciada per múltiples factors contextuals, però que alhora té un paper actiu en la conformació d'aquest context.
...
Internet, els buscadors, les plataformes multimèdia, les xarxes socials, les plataformes de vídeos curts i les eines d’IA, entre d’altres, ocupen moltes hores en el dia a dia dels joves i adolescents \parencite{shutaleva} ---i també dels adults---. Però són aquestes eines competidores directes de l'activitat lectora? No hi ha un consens clar al respecte en la literatura científica existent, ja que alguns estudis conclouen que l'ús de xarxes socials es correlaciona negativament amb el temps dedicat a la lectura de forma significativa \parencite{akande_library}, mentre que altres estudis no troben prou significació per sostenir aquesta afirmació \parencite{shutaleva}. 
...
Partint del context descrit, he volgut enfocar la meva investigació en la composició d'una fotografia completa dels hàbits de lectura de l'alumnat adolescent en el meu centre de pràctiques. En concret, es pretén respondre a la següent pregunta de recerca: quins són els hàbits de lectura de l’alumnat adolescent del centre educatiu estudiat i quins factors es troben associats al seu desenvolupament?

Per donar resposta a aquesta pregunta, l’objectiu general de la recerca és descriure de forma detallada i exhaustiva els hàbits de lectura de l’alumnat adolescent en el centre d'estudi, així com de les possibles variables que poden estar relacionades. Aquest propòsit general es concreta en els següents objectius específics:

\begin{itemize}
    \item Descriure la freqüència, formats utilitzats i preferències temàtiques de lectura per oci de l’alumnat.
...
En primer lloc, segons l'\emph{Informe de resultados de Hábitos de lectura y compra de libros en España} \nestedtextcite{2018}{sanches} el 44.7\% dels joves entre 15 i 18 anys és lector freqüent, mentre que el 22.7\% és lector ocasional i el 32.6\% es declara no lector. Per aquest motiu, \textcite{sanches} suggereixen que la lectura s'està convertint en una activitat obligada per qüestions pràctiques, oblidant la forta relació entre el rendiment acadèmic i gaudir per la lectura.

D'altra banda, l’estudi de \textcite{shutaleva} conclou que la lectura continua sent una activitat present en l’oci juvenil, tot i la creixent presència de les tecnologies digitals. L’estudi destaca la importància del nivell d'estudis dels pares, la disponibilitat d'una biblioteca a casa, la implicació parental en la lectura i el fet de tenir amb qui compartir les experiències lectores en la conformació dels hàbits de lectura dels adolescents. Així mateix, es posa de manifest que les noies tendeixen a compartir més les seves experiències lectores, mentre que no es troben diferències significatives en la quantitat de lectura entre gèneres. Aquest estudi també suggereix que el format de lectura predominant continua sent el llibre físic, tot i l’augment progressiu dels formats digitals i els audiollibres.

Respecte a l’associació entre el temps dedicat a les tecnologies digitals i els hàbits de lectura, no hi ha un consens clar en la literatura científica existent. \textcite{akande_library} conclouen que existeix una correlació negativa significativa entre el temps dedicat a les xarxes socials i el temps dedicat a la lectura per oci, fet que suggereix una competència temporal entre ambdues activitats.

Tanmateix, l’estudi longitudinal de \textcite{johnsson_bookreading} aporta una perspectiva evolutiva dels hàbits lectors al llarg de 25 anys. Els resultats mostren que, malgrat l’augment significatiu de l’ús de tecnologies digitals, el temps dedicat a la lectura no ha disminuït de manera proporcional i fins i tot ha augmentat en determinats grups. En aquest sentit, no s’observa una correlació clara entre l’ús de tecnologies i la lectura per oci, fet que qüestiona la idea d’una competència directa entre ambdues activitats. L’estudi, però, sí que identifica una lleugera correlació negativa entre el temps dedicat a veure la televisió i la lectura.

Una altra conclusió interessant d’aquest estudi és que la lectura per oci s’ha polaritzat lleugerament amb el pas del temps: ha augmentat el nombre d’adolescents que no llegeixen mai per oci, mentre que aquells que ja llegien han incrementat el temps que hi dediquen. Pel que fa al gènere, els resultats indiquen que les noies acostumen a llegir més que els nois, que la proporció de nois que no llegeixen mai per oci és superior a la de noies i que aquestes diferències es mantenen al llarg del temps. Finalment, els autors conclouen que els hàbits de lectura estan més condicionats pel context familiar i social que no pas per l’ús de tecnologies digitals.
...
\subsection{Disseny de recerca i mostreig}
% ---------------------------------------------------
...
La mostra de l’estudi s’ha configurat mitjançant un disseny mixt. En la fase quantitativa, s’ha utilitzat un mostreig no probabilístic per conglomerats, prenent com a unitats d’anàlisi els grups-classe dels cursos de 3r d’ESO a 2n de Batxillerat del centre estudiat. En total, el qüestionari ha estat administrat a 343 alumnes, amb l’excepció d’un grup de 4t d’ESO que no ha pogut participar per motius organitzatius i de coordinació.

En la fase qualitativa, s’ha aplicat un mostreig no probabilístic per conveniència, seleccionant participants que han accedit voluntàriament a realitzar entrevistes semiestructurades. Concretament, s’han entrevistat tres docents de les assignatures de Llengua i Literatura Catalana i Castellana i dos alumnes de 1r i 2n de Batxillerat.

L’abast de l’estudi s’ha delimitat als cursos de 3r d’ESO a 2n de Batxillerat, excloent els nivells inicials de 1r i 2n d'ESO per limitacions temporals i de recursos, així com per mantenir la coherència amb els objectius plantejats, centrats en l'anàlisi dels hàbits lectors de l'alumnat adolescent.
...
Finalment, s’han inclòs també ítems específics dissenyats per al context concret de l’estudi, com ara analitzar la narrativa i la percepció social sobre la lectura o conèixer les preferències lectores.
...
En una primera fase, s'ha realitzat una anàlisi descriptiva de les dades, amb l'objectiu de conèixer les característiques generals de la mostra, descriure els hàbits de lectura de l'alumnat a partir del temps mitjà setmanal dedicat a la lectura de llibres o còmics per oci i el nombre de llibres o còmics llegits en els últims 12 mesos per oci.
...
\[
\text{\emph{Pàg. estimades}} = \text{\emph{Mitjana llibres}} \cdot \text{\emph{Mitjana pàg. per llibre}}
\]
...
Aquesta tendència també s’observa a la \autoref{fig:llibres_genere}. Un 42.9\% dels nois no ha llegit cap llibre o còmic per oci en l'últim any, respecte d'un 28.1\% de les noies. En la mateixa línia, les noies concentren percentatges superiors en les categories de lectura més elevades, especialment entre 6 i 10 llibres o còmics anuals (13.5\% envers el 7.1\% dels nois) i en més de 10 llibres (12.4\% envers el 6.4\% dels nois).
...
La prova $\chi^2$ d’independència indica que existeix una associació estadísticament significativa entre el gènere i els indicadors d'hàbits lectors: el temps setmanal dedicat a la lectura per oci ($\chi^2 = 17.136$, $p = .004$) i el nombre de llibres o còmics llegits durant els darrers 12 mesos per oci ($\chi^2 = 13.289$, $p = .021$). Tanmateix, els valors del coeficient V de Cramér indiquen que aquestes associacions són de baixa intensitat (V = .227 i V = .199, respectivament).
...
Pel que fa al curs acadèmic, no s’observa una tendència evolutiva clara entre els diferents nivells educatius. Concretament, destaca el curs de 4t d’ESO que presenta una menor dedicació a la lectura per oci, tant en termes de temps setmanal com de nombre de llibres llegits. En relació amb l’itinerari, no s’identifiquen diferències rellevants entre l’alumnat de Ciències Socials i el de Ciències i Tecnologia.
...
\end{tabular}
\vspace{0.5em}
\caption{Estadístics de la variable nombre de pàgines estimades llegides de llibres o còmics per oci en els últims 12 mesos del conjunt mostral.}
...
Aquestes diferències estadístiques mostren com el volum de lectura per oci és considerablement més elevat en les noies que en els nois, resultat que concorda amb l'esmentat en l'apartat anterior.
...
% ---------------------------------------------------
El 67.3\% de l'alumnat declara no haver anat cap vegada a la biblioteca per agafar llibres o còmics en préstec durant l’últim any, mentre que només una petita proporció d’alumnes (11.7\%) hi ha anat més de tres vegades.
...
En concordança amb aquests resultats, la \autoref{fig:altres_hang_class} mostra que un 24.9\% dels no lectors o lectors molt ocasionals dedica, de mitjana, menys de 30 minuts diaris a quedar amb amics, amigues o parella sentimental, respecte al 42.5\% dels lectors ocasionals i al 49.1\% dels lectors habituals.
...
En coherència amb aquests resultats, la \autoref{fig:familia_normes_class} mostra que un 51.0\% dels no lectors o lectors molt ocasionals estan en desacord o molt en desacord amb l'afirmació de si tenen normes clares a casa sobre l'ús de pantalles, respecte al 48.9\% dels lectors ocasionals i al 30.5\% dels lectors habituals. D'altra banda, un 20.7\% dels no lectors o lectors molt ocasionals estan d'acord o molt d'acord amb aquesta afirmació, proporció que augmenta fins al 25.5\% en els lectors ocasionals i fins al 44.0\% en els lectors habituals.
...
En sintonia, les correlacions observades respecte d'aquesta qüestió són positives febles, tant amb el temps de lectura setmanal ($\rho = .295$, $p < .001$) com amb el nombre de llibres llegits anualment ($\rho = .300$, $p < .001$).
...
% ---------------------------------------------------
Els resultats obtinguts mostren que els hàbits lectors de llibres o còmics per oci de l'alumnat del centre són baixos en termes generals. La major part de la mostra es concentra en les categories de 0 o menys de 30 minuts de temps mitjà dedicat a la setmana a la lectura de llibres o còmics per oci (67.9\%), i de cap o 1-2 llibres o còmics llegits anualment per oci (61.2\%). Una dada reveladora és que més de la meitat de l'alumnat (51.3\%) dedica 0 minuts, de mitjana en una setmana habitual, a la lectura de llibres o còmics per oci.

De manera coherent, el nombre de pàgines estimades llegides per oci de llibres o còmics durant l'últim any és, en general, també molt baix; amb una mitjana de 1191 pàgines i una mediana de 300 pàgines. Aquests estadístics tan baixos i la gran diferència entre mitjana i mediana indiquen una asimetria positiva en la distribució: la major part de l'alumnat ha llegit molt poques pàgines estimades de llibres o còmics per oci aquest últim any, mentre que una minoria de lectors habituals n'ha llegit una quantitat considerable, elevant així la mitjana i la desviació típica de la distribució.

En consonància, la classificació lectora construïda a partir dels indicadors de temps mitjà setmanal de lectura de llibres o còmics per oci, i del nombre de llibres o còmics llegits l'últim any per oci, situa la majoria dels participants (69.1\%) en la categoria de \emph{no lector / lector molt ocasional}.

Tal com s'ha esmentat, malgrat la baixa freqüència general de lectura de llibres o còmics per oci, també s’observa l’existència d’un grup reduït però clarament consolidat de lectors habituals, amb volums de lectura molt superiors a la resta de la mostra. Aquest fet provoca que la distribució sigui fortament asimètrica, suggerint una elevada polarització dels hàbits lectors de llibres o còmics per oci dins l’alumnat.

Les dades qualitatives recollides reforcen aquesta interpretació. Tant l'alumnat com el professorat coincideixen a assenyalar que la lectura per oci és una pràctica minoritària entre els adolescents, descrivint-la com una activitat habitual només en grups reduïts de lectors consolidats: <<2 o 3 per classe és la ràtio habitual, però aquests són lectors empedreïts>>, <<els alumnes llegeixen molt poc en general, però n'hi ha grupets que sí que llegeixen bastant>>. 

Els resultats obtinguts són coherents amb l'estudi de \textcite{johnsson_bookreading}, en què es conclou que la lectura s'ha polaritzat lleugerament amb el pas del temps: s'ha incrementat el nombre d'adolescents que no llegeixen mai per oci, mentre que els que ja llegien han augmentat el temps de lectura. En canvi, són parcialment congruents amb els resultats de l'\emph{Informe de resultados de Hábitos de lectura y compra de libros en España} \nestedtextcite{2018}{sanches}, ja que aquest estudi conclou que els nivells de lectura són generalment baixos, però els percentatges són considerablement més elevats que els obtinguts en el present estudi.
...
Aquesta diferència també es veu reflectida en les dades qualitatives, on diversos participants assenyalen explícitament que <<les nenes llegeixen més que els nois, bastant més>> o que <<les noies llegeixen en general més que els nois>>, i fins i tot es descriu una menor presència de nois en activitats lectores socials o compartides.
...
Els resultats obtinguts són coherents amb els de \textcite{johnsson_bookreading}, que conclou que les noies acostumen a llegir més que els nois, que la proporció de nois que no llegeixen mai per oci és superior a la de noies i que aquestes diferències es mantenen al llarg del temps.
...
% ---------------------------------------------------
Quant al curs acadèmic i a l’itinerari de batxillerat, no s’observen diferències clares ni consistents en els hàbits de lectura per oci. En el cas del curs, no es detecta una tendència evolutiva entre nivells educatius que permeti afirmar que els hàbits lectors augmentin o disminueixin de manera consistent a mesura que l’alumnat avança en l’etapa educativa. Cal esmentar que el curs de 4t d'ESO destaca especialment per presentar indicadors de lectura més baixos que la resta de cursos. 

De la mateixa manera, l'itinerari del batxillerat ---Ciències Socials o Ciències i Tecnologia--- no sembla exercir una influència destacable sobre els hàbits lectors per oci de l’alumnat del centre (\autoref{fig:temps_itinerari}; \autoref{fig:llibres_itinerari}).

\subsection{Lectura per oci i lectures obligatòries de l'escola}
% ---------------------------------------------------
Els resultats obtinguts mostren que la relació entre el grau de lectura de les lectures obligatòries del centre i els hàbits lectors de llibres o còmics per oci és limitada. Tot i que s’observa una tendència a un major compliment de les lectures obligatòries entre l’alumnat amb hàbits lectors més consolidats, les correlacions són febles.

Aquest patró es veu confirmat per les dades qualitatives, que mostren una percepció majoritàriament negativa per part de l'alumnat respecte a les lectures obligatòries i un potencial molt limitat com a factor de promoció dels hàbits lectors per oci. Tant alumnes com professors descriuen el compliment d'aquestes lectures com una activitat que es realitza com a obligació per obtenir una qualificació més, que es materialitza en un ús elevat de resums d'internet, intel·ligència artificial o consulta als companys de classe per realitzar les proves associades; però majoritàriament desvinculada del plaer lector o de la motivació per llegir per oci: <<les lectures obligatòries de l’escola no fomenten en absolut el gust per la lectura>>, <<molts alumnes no les llegeixen i busquen resums a internet, ho he constatat amb alumnes que al final de curs ho han reconegut obertament>>, <<tots els treballs sobre les obres són exactament iguals, i això és perquè, investigant, trobes que són un Ctrl+C i Ctrl+V de certes pàgines d'internet>>, <<els alumnes no veuen les lectures obligatòries com una oportunitat, sinó com una nota més per aprovar o suspendre, l'objectiu és treure-s'ho de sobre com més aviat millor>>, <<em fa la sensació que molt pocs alumnes descobreixen el gust per la lectura a través de les lectures obligatòries de l'escola>>.

En consonància, la valoració de les lectures obligatòries és considerablement negativa, ja que només un 9.9\% de l’alumnat declara que li agraden bastant o molt. Tanmateix, una part significativa de l’alumnat indica que llegiria més aquestes lectures si s’ajustessin més als seus interessos personals. En aquest sentit, els resultats estadístics mostren una relació moderada entre el gust per les lectures obligatòries i el grau en què aquestes es llegeixen. Aquest fet posa de manifest que, tot i que cap d'ells és un factor clarament determinant, el gust per les lectures obligatòries es relaciona més positivament amb la lectura de les mateixes que el fet de tenir hàbits lectors consolidats per oci.

Les dades qualitatives també reflecteixen aquesta situació, tot i que potser es magnifica la relació entre el gust per les lectures obligatòries i el grau de lectura de les mateixes en comparació amb els resultats quantitatius; ja que hi ha un cert grau de \emph{quorum} en què el fet d'escollir, amb uns certs límits, les lectures obligatòries seria un factor determinant en què aquestes es llegissin més i en fomentar el gust i la motivació per la lectura per oci: <<facilitaria que els alumnes les llegissin més i probablement fomentaria més el seu interès per la lectura>>, <<jo crec que llegiríem més si poguéssim escollir [...] si n'hi hagués un llistat de lectures de les quals els alumnes haguéssim d'escollir segur que ens motivaria més que no pas una lectura obligada>>.

Tot i això, també n'hi ha una tendència a considerar que és necessari mantenir un cert grau de lectures escollides pels docents, ja que aquestes poden actuar com a guia i orientació per a l’alumnat, i permeten apropar i treballar continguts de lectures que difícilment treballarien pel seu compte: <<és necessari que hi hagi lectures obligatòries escollides pels docents per aquells que sí les llegeixen, perquè si nosaltres no els hi donem l'oportunitat de llegir-ho i d'interpretar-ho conjuntament, difícilment ells pel seu compte s'apropin a aquestes lectures. Per exemple, si tu els apropes els clàssics, és molt més probable que s'interessin per ells>>.

En conjunt, els resultats apunten a una desconnexió entre les preferències lectores de l’alumnat i les lectures proposades en l’àmbit escolar, fet que podria incidir en el nivell de compromís amb aquestes. En la mateixa línia, actualment la lectura obligatòria del centre, almenys tal com és percebuda per una part rellevant de l’alumnat ---i part del professorat---, no actua com un factor de promoció dels hàbits lectors per oci.

Aquests resultats són coherents amb l'\emph{Informe de resultados de Hábitos de lectura y compra de libros en España} \nestedtextcite{2018}{sanches}, on es conclou que la lectura s'està convertint en una activitat obligada per qüestions pràctiques, oblidant la forta relació entre el rendiment acadèmic i gaudir per la lectura.

\subsection{Lectura per oci, una activitat social}
% ---------------------------------------------------
Un dels resultats més rellevants de la investigació és la importància de la percepció personal sobre la lectura i les interaccions socials al voltant d'aquesta en la configuració dels hàbits lectors per oci de l'alumnat del centre. En aquest sentit, els resultats mostren que tenir una percepció personal positiva sobre la lectura s'associa fortament amb hàbits lectors per oci més consolidats.

Aquest patró es veu reforçat per les dades qualitatives, on diversos participants descriuen la lectura com una activitat “agradable” i “positiva”, assenyalant que aquesta percepció s'incrementa amb els hàbits lectors o l'activitat lectora: <<l'opinió sobre la lectura és molt positiva en aquells alumnes que hem tingut una lectura base, uns hàbits de lectura>>, <<la gent no llegeix perquè no ha trobat un llibre que li agradi, cadascú ha de trobar el seu llibre, perquè quan un llibre t'agrada ja no estàs llegint un llibre, sinó descobrint un món>>.

D'altra banda, la percepció social sobre la lectura entre els adolescents no mostra una associació significativa amb els hàbits lectors per oci, suggerint que aquesta variable no té rellevància en els hàbits lectors de l’alumnat del centre. De fet, la major part de l’alumnat considera que la lectura és socialment percebuda com una activitat neutra o negativa, mentre que només una proporció reduïda considera que es percep socialment com a positiva. 

Aquest fet s'alinea amb la percepció expressada per diversos participants, que assenyalen que existeixen estereotips socials negatius associats a la lectura, com ara que és una activitat avorrida o rara: <<socialment la lectura està mal vista, com una pèrdua de temps>>, <<em fa l'efecte que a l'ESO, tot allò que se surt dels estereotips establerts és vist com a negatiu>>, o referències a situacions de burla o incomprensió en contextos escolars relacionades amb el fet de llegir.

Els resultats anteriors contrasten sorprenentment amb la percepció personal sobre la lectura, que és majoritàriament positiva: la major part de l'alumnat considera la lectura com una activitat interessant, molt interessant o agradable. D'aquesta manera, es detecten en l'alumnat adolescent del centre uns estereotips socials negatius associats a la lectura, com també hem vist a l'anàlisi qualitativa, però que no es corresponen amb la percepció personal que tenen sobre aquesta activitat. Tanmateix, aquests estereotips no semblen tenir una influència directa en els hàbits lectors per oci.
...
De manera coherent, els resultats relacionats amb el consum de contingut audiovisual sobre llibres o lectura també apunten en aquesta direcció. Lluny d’actuar com a competidor de la lectura, dedicar temps a veure o sentir aquest tipus de contingut sembla funcionar un estímul que potencia els hàbits lectors per oci de l'alumnat del centre; configurant un espai de socialització lectora, on els adolescents poden descobrir nous llibres, compartir recomanacions i sentir-se part d’una comunitat lectora.

Les dades qualitatives reafirmen aquesta interpretació, ja que diversos participants assenyalen que les recomanacions de llibres per part de persones del seu entorn o a través de plataformes digitals són un factor clau en el descobriment de nous i llibres i en la motivació per llegir.

En conjunt, els resultats són coherents amb els obtinguts per \textcite{shutaleva}, que destaca la importància del context social i, sobretot, de disposar de persones amb qui compartir les experiències lectores. La literatura existent reforça aquesta idea en assenyalar la gran importància del grup d’iguals durant l’etapa adolescent \parencite{berger}.

\subsection{Lectura per oci i biblioteca}
% ---------------------------------------------------
En relació amb les visites a la biblioteca per agafar llibres o còmics en préstec durant l’últim any, els resultats mostren una baixa freqüència general d’aquesta activitat per part de l’alumnat (\autoref{fig:tipologia_biblio}), suggerint que la biblioteca no és un espai habitual de consum de llibres o còmics per oci per a la major part de l’alumnat del centre. Tanmateix, una vinculació més elevada amb la biblioteca s’associa amb hàbits lectors per oci més consolidats, suggerint que la biblioteca pot actuar com un recurs que es relaciona amb el desenvolupament d’hàbits lectors per oci en una part de l’alumnat del centre.

D'altra banda, les visites a la biblioteca realitzades amb la família durant la infància i l'adolescència no mostren una associació significativa amb els hàbits lectors per oci de l’alumnat del centre, suggerint que aquesta variable no té un paper rellevant en la configuració dels hàbits lectors per oci de l’alumnat del centre. 

Finalment, cal destacar que el nombre de llibres disponibles a casa durant la infància i l'adolescència mostra una relació feble positiva amb els hàbits lectors per oci, suggerint que aquest factor sí que s'associa amb la configuració d'hàbits lectors per oci de l’alumnat del centre, tot i que no es pot afirmar que sigui un factor determinant.

Aquests resultats troben suport relatiu en les dades qualitatives, ja que diversos participants descriuen entorns familiars amb una elevada presència de llibres i assenyalen que disposar de materials de lectura a l’abast ---sigui a través de la biblioteca o a casa--- facilita l’aproximació espontània a la lectura.

\subsection{Lectura per oci, noves tecnologies i xarxes socials}
% ---------------------------------------------------
Pel que fa a la relació entre els hàbits lectors i el temps d'ús de les noves tecnologies, els resultats mostren una realitat més complexa que una simple oposició entre lectura i pantalles, qüestionant la idea generalitzada que les noves tecnologies i les xarxes socials afecten directament i de manera significativa als hàbits de lectura de llibres o còmics per oci de l'alumnat. 

Aquesta interpretació també es veu reflectida en les dades qualitatives, on diversos participants assenyalen que les noves tecnologies presenten tant oportunitats com riscos per a la lectura, i que l'element determinant no és la tecnologia en si mateixa, sinó l'ús que se'n fa.

Ni el temps diari mitjà dedicat a l’ús de dispositius digitals per a l’oci ---tot i ser aquest molt més elevat en el conjunt de la mostra que el temps dedicat a la lectura per oci---,  ni el dedicat a veure sèries, pel·lícules, \emph{streamings} o jugar a videojocs mostren relacions significatives amb els hàbits lectors per oci. Aquest fet suggereix que aquestes activitats no actuen com a competidores directes de la lectura per oci, i que, per tant, es descarta que un ús més intensiu de les noves tecnologies impliqui necessàriament una menor activitat lectora de llibres o còmics per oci en l'alumnat del centre.

Paral·lelament, sí que s’observa una relació negativa feble entre els hàbits lectors i l’ús intensiu de xarxes socials o plataformes de contingut audiovisual ràpid. Tot i la baixa magnitud de les correlacions, els resultats descriptius mostren una presència més elevada de no lectors entre l’alumnat que dedica moltes hores diàries a aquest tipus de consum digital. Tanmateix, malgrat que el temps diari mitjà dedicat a l’ús de xarxes socials o plataformes de contingut audiovisual ràpid sigui molt més elevat en el conjunt de la mostra (\autoref{fig:tric_time}) que el temps mitjà dedicat a la lectura per oci, no es pot afirmar que existeixi una competència temporal directa, i que el temps diari mitjà dedicat a l’ús de xarxes socials actuï com un factor determinant en els hàbits lectors de l’alumnat per oci.

Aquests resultats són coherents amb els obtinguts per \textcite{johnsson_bookreading} i \textcite{shutaleva}, on no es detecta una associació significativa entre el temps dedicat a les noves tecnologies i els hàbits lectors de llibres o còmics per oci. En canvi, són contradictoris amb l'estudi \textcite{akande_library}, on es conclou que l'ús de les noves tecnologies sí que s'associa amb una menor activitat lectora.

D'altra banda, els resultats sobre la consulta freqüent de xarxes socials durant la lectura suggereixen que una freqüència més elevada de consulta de xarxes socials durant l'activitat lectora sí que s’associa amb sessions de lectura més curtes i amb nivells més baixos d'hàbits lectors per oci. Addicionalment, els resultats mostren que la durada habitual de les sessions de lectura per oci es correlaciona positivament de forma moderada amb els hàbits de lectors per oci. En conjunt, els resultats suggereixen que realitzar sessions de lectura més llargues i amb menys interrupcions s'associa amb hàbits lectors per oci més consolidats.

En aquest sentit, un altre aspecte interessant és que la presència de normes clares a casa sobre l’ús de pantalles mostra una relació estadísticament significativa amb els hàbits lectors per oci, tot i que de magnitud molt feble. Aquest resultat s’alinea amb les dades qualitatives, on alguns participants assenyalen que establir límits en l’ús de les xarxes socials o reduir les interrupcions digitals durant la lectura els permet concentrar-se millor, dedicar més temps i gaudir més de l'activitat. En aquest sentit, se suggereix que l’efecte d’aquestes plataformes no estaria vinculat a una substitució directa del temps de lectura, sinó més aviat a la fragmentació de l’atenció.

Potser per aquest motiu, el format àmpliament preferit per l’alumnat per a la lectura de llibres o còmics per oci continua sent el format físic o en paper tradicional (88.4\%). Els formats digitals, com els \emph{ebooks}, les plataformes de lectura digital, els audiollibres o els arxius PDF, tenen una presència molt minoritària com a formats preferents per a la lectura de llibres o còmics per oci en la mostra. Aquest resultat suggereix que, malgrat la digitalització creixent de l’entorn juvenil, i la gran quantitat d'hores dedicades a l'ús de tecnologies digitals per a l'oci (\autoref{fig:tec_time}), la lectura per oci continua sent una activitat vinculada principalment al suport físic tradicional.

La preferència pel format físic també apareix en les dades qualitatives, on alguns participants associen el format en paper amb una experiència lectora més agradable i immersiva que la proporcionada pels dispositius digitals.

Aquests resultats són coherents amb els obtinguts per \textcite{shutaleva}.

\subsection{Lectura per oci i altres activitats d'oci}
% ---------------------------------------------------
Pel que fa a la relació entre els hàbits lectors i altres activitats quotidianes dels estudiants, els resultats mostren patrons diferenciats segons el tipus d’activitat analitzada. En primer lloc, no s’observa cap associació significativa entre el temps mitjà dedicat a l’estudi i tasques acadèmiques fora de l'horari escolar i els indicadors d’activitat lectora ---tot i que la percepció de la càrrega acadèmica com a factor limitant per a la lectura per oci està força generalitzada entre l’alumnat---.

D'altra banda, el temps mitjà dedicat a activitats culturals sí que presenta correlacions positives febles amb els hàbits lectors per oci, suggerint que els alumnes que dediquen més temps setmanal a activitats culturals tendeixen a llegir més habitualment per oci, formant ambdues activitats part d’un mateix grup o perfil d'interessos i preferències.

Finalment, el temps mitjà dedicat a quedar amb amics, amigues o parella sentimental mostra correlacions negatives febles amb els hàbits lectors per oci, suggerint que dedicar més temps a aquest tipus d’activitat social s’associa lleugerament amb dedicar menys temps a la lectura de llibres o còmics per oci.

\subsection{Lectura per oci i entorn familiar pro-lector}
% ---------------------------------------------------
L'anàlisi dels resultats obtinguts sobre aquesta qüestió determina una influència feble-moderada de l'entorn familiar pro-lector en els hàbits lectors de llibres o còmics per oci de l'alumnat del centre. Factors tradicionalment associats a un increment de l'interès per la lectura com el nivell d'estudis familiars, la freqüència de veure els pares llegint o la freqüència amb què s'han realitzat sessions de lectura conjunta amb les famílies durant la infància i adolescència, no presenten relacions estadísticament significatives amb els hàbits lectors per oci dels estudiants.

Les dades qualitatives aporten una visió més matisada, suggerint que la influència de l’entorn familiar podria no ser homogènia. Alguns participants assenyalen que les pràctiques de lectura compartida durant la infància i el fet que els pares llegeixin, en els seus casos personals, han actuat com factors clarament potenciadors del seu desenvolupament d’hàbits lectors. D'altra banda, altres participants descriuen un patró en què la influència lectora dels progenitors durant la infància sembla no mantenir-se durant l'adolescència, assenyalant que, tot i haver estat exposats a la lectura de manera continuada en edats primerenques, aquesta influència es dilueix en l’etapa adolescent, coincidint amb períodes de menor interès lector i una reducció de la influència dels models familiars. En aquesta línia, s’apunta que la influència dels pares pot recuperar-se o reaparèixer en etapes posteriors del desenvolupament, quan els joves consoliden de nou l’interès per la lectura.

Aquesta interpretació és congruent amb la literatura existent, que suggereix que en aquesta etapa del desenvolupament, es produeix un cert distanciament  amb els pares per factors biològics, cognoscitius i culturals \parencite{arnett}.

Paral·lelament, el nombre de llibres disponibles a la llar durant la infància i adolescència i la freqüència de parlar o compartir opinions sobre lectures amb les famílies sí que mostren associacions positives significatives amb els hàbits de lectura de llibres o còmics per oci, encara que de magnitud feble. Aquesta relació també es veu reflectida en les dades qualitatives, on diversos participants descriuen entorns familiars amb una elevada presència de llibres i experiències habituals d'intercanvi d'opinions lectores amb familiars propers, especialment amb mares i germanes.

Aquests resultats són parcialment coherents amb els obtinguts per \textcite{shutaleva}, on es conclou que la disponibilitat de llibres a la llar s'associa positivament amb els hàbits lectors per oci de l'alumnat. Tanmateix, a diferència del que assenyalen aquests autors, variables relacionades amb la implicació parental en la lectura durant la infància i adolescència o el nivell d'estudis dels pares no presenten associacions estadísticament significatives en la mostra analitzada.

Els resultats també indiquen una associació feble-moderada entre compartir opinions sobre lectures amb la família i els hàbits lectors per oci, en coherència amb el que s’observa també en relació amb les amistats i el consum de contingut audiovisual vinculat a la lectura. En conjunt, suggereixen que les interaccions socials al voltant de la lectura ---tant familiars com entre iguals--- poden contribuir a la configuració dels hàbits lectors de l’alumnat, reforçant la idea de la lectura com una pràctica social. No obstant això, les relacions amb el grup d’iguals mostren una associació més forta que les familiars, cosa que apunta a una major influència de les amistats en la consolidació dels hàbits lectors per oci durant l’adolescència, en línia amb la literatura existent sobre la rellevància del grup d'iguals en aquesta etapa \parencite{arnett}.
