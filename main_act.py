...
# Plots
if which_plot == 1:
    plots.plot_1(axis_x, groups, group_var, full_stats_df, start_fig)

elif which_plot == 2:
    plots.plot_2(axis_x, groups, group_var, full_stats_df, start_fig)

elif which_plot == 3:
    plots.plot_double_boxplot(axis_x, groups, group_var, "Pre-D", "Post-D", df, full_stats_df, start_fig)
    plots.plot_double_boxplot(axis_x, groups, group_var, "Pre-Son", "Post-Son", df, full_stats_df, start_fig + 1)

elif which_plot == 4:
    plots.plot_double_boxplot(axis_x, groups, group_var, "Pre-T", "Post-T", df, full_stats_df, start_fig)
    plots.plot_double_boxplot(axis_x, groups, group_var, "Pre-I", "Post-I", df, full_stats_df, start_fig + 1)
    plots.plot_double_boxplot(axis_x, groups, group_var, "Pre-V", "Post-V", df, full_stats_df, start_fig + 2)
